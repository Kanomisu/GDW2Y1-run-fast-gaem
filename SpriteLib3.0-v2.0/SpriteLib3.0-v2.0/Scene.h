...
public:
	...
	void CreateBoxEntity(std::string fileName, int spriteX, int spriteY, int vecX, int vecY, int rotDeg = 0, int vecZ = 10.f, bool isDynamic = false, float shrinkXValue = 0, float shrinkYValue = 0);
